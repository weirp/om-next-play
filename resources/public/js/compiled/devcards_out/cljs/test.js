...
var args30957 = [];
var len__17402__auto___30961 = arguments.length;
var i__17403__auto___30962 = (0);
while(true){
if((i__17403__auto___30962 < len__17402__auto___30961)){
args30957.push((arguments[i__17403__auto___30962]));

var G__30963 = (i__17403__auto___30962 + (1));
i__17403__auto___30962 = G__30963;
continue;
} else {
}
break;
...
var G__30960 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
var G__30960__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__30960,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__30960);
return G__30960__$1;
});
...
var or__16344__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__17402__auto___30968 = arguments.length;
var i__17403__auto___30969 = (0);
while(true){
if((i__17403__auto___30969 < len__17402__auto___30968)){
args__17409__auto__.push((arguments[i__17403__auto___30969]));

var G__30970 = (i__17403__auto___30969 + (1));
i__17403__auto___30969 = G__30970;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__17410__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq30965){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__30966,G__30967,seq30965__$2);
});
...
var file = cljs.core.get.call(null,map__30974__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__30974__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__30974__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__30974,map__30974__$1,file,line,column){
return (function (p1__30971_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__30971_SHARP_));
});})(map__30974,map__30974__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__17257__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__17257__auto__,prefer_table__17258__auto__,method_cache__17259__auto__,cached_hierarchy__17260__auto__,hierarchy__17261__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__16344__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__16344__auto__)){
return or__16344__auto__;
} else {
...
var temp__4425__auto___30976 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___30976)){
var message_30977 = temp__4425__auto___30976;
cljs.core.println.call(null,message_30977);
} else {
}
...
var temp__4425__auto___30978 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___30978)){
var message_30979 = temp__4425__auto___30978;
cljs.core.println.call(null,message_30979);
} else {
}
...
var temp__4423__auto__ = (function (){var and__16332__auto__ = typeof exception.stack === 'string';
if(and__16332__auto__){
var G__30985 = exception.stack;
var G__30985__$1 = (((G__30985 == null))?null:clojure.string.split_lines.call(null,G__30985));
var G__30985__$2 = (((G__30985__$1 == null))?null:cljs.core.get.call(null,G__30985__$1,depth));
var G__30985__$3 = (((G__30985__$2 == null))?null:clojure.string.trim.call(null,G__30985__$2));
return G__30985__$3;
} else {
...
var vec__30986 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__30986,(0),null);
var column = cljs.core.nth.call(null,vec__30986,(1),null);
var vec__30987 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__30987,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__30987,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__30987,(2),null);
...
var m__$1 = (function (){var G__30989 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__30989) {
case "fail":
...
var G__30995 = (function (){var G__30994 = cljs.core.rest.call(null,fns);
var G__30994__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__30994):G__30994);
return G__30994__$1;
})();
fns = G__30995;
continue;
...
var G__30997 = fns;
var G__30997__$1 = (((G__30997 == null))?null:cljs.core.vary_meta.call(null,G__30997,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__30997__$1;
});
...
}catch (e31000){var e = e31000;
var G__31001 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__31001) {
...
var vec__31004 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__31004,(0),null);
var types = vec__31004;
...
return cljs.core.map.call(null,(function (p__31012){
var vec__31013 = p__31012;
var ns = cljs.core.nth.call(null,vec__31013,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__31013,(1),null);
return ((function (vec__31013,ns,vars__$1){
return (function (){
...
var G__31014 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__31014) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__31014,env,once_fixtures,each_fixtures,vec__31013,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__31014,env,once_fixtures,each_fixtures,vec__31013,ns,vars__$1){
return (function (){
var seq__31015 = cljs.core.seq.call(null,vars__$1);
var chunk__31016 = null;
var count__31017 = (0);
var i__31018 = (0);
while(true){
if((i__31018 < count__31017)){
var v = cljs.core._nth.call(null,chunk__31016,i__31018);
var temp__4425__auto___31020 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___31020)){
var t_31021 = temp__4425__auto___31020;
each_fixture_fn.call(null,((function (seq__31015,chunk__31016,count__31017,i__31018,t_31021,temp__4425__auto___31020,v,each_fixture_fn,G__31014,env,once_fixtures,each_fixtures,vec__31013,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_31021)));
});})(seq__31015,chunk__31016,count__31017,i__31018,t_31021,temp__4425__auto___31020,v,each_fixture_fn,G__31014,env,once_fixtures,each_fixtures,vec__31013,ns,vars__$1))
);
} else {
}

var G__31022 = seq__31015;
var G__31023 = chunk__31016;
var G__31024 = count__31017;
var G__31025 = (i__31018 + (1));
seq__31015 = G__31022;
chunk__31016 = G__31023;
count__31017 = G__31024;
i__31018 = G__31025;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__31015);
if(temp__4425__auto__){
var seq__31015__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__31015__$1)){
var c__17147__auto__ = cljs.core.chunk_first.call(null,seq__31015__$1);
var G__31026 = cljs.core.chunk_rest.call(null,seq__31015__$1);
var G__31027 = c__17147__auto__;
var G__31028 = cljs.core.count.call(null,c__17147__auto__);
var G__31029 = (0);
seq__31015 = G__31026;
chunk__31016 = G__31027;
count__31017 = G__31028;
i__31018 = G__31029;
continue;
} else {
var v = cljs.core.first.call(null,seq__31015__$1);
var temp__4425__auto___31030__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___31030__$1)){
var t_31031 = temp__4425__auto___31030__$1;
each_fixture_fn.call(null,((function (seq__31015,chunk__31016,count__31017,i__31018,t_31031,temp__4425__auto___31030__$1,v,seq__31015__$1,temp__4425__auto__,each_fixture_fn,G__31014,env,once_fixtures,each_fixtures,vec__31013,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_31031)));
});})(seq__31015,chunk__31016,count__31017,i__31018,t_31031,temp__4425__auto___31030__$1,v,seq__31015__$1,temp__4425__auto__,each_fixture_fn,G__31014,env,once_fixtures,each_fixtures,vec__31013,ns,vars__$1))
);
} else {
}

var G__31032 = cljs.core.next.call(null,seq__31015__$1);
var G__31033 = null;
var G__31034 = (0);
var G__31035 = (0);
seq__31015 = G__31032;
chunk__31016 = G__31033;
count__31017 = G__31034;
i__31018 = G__31035;
continue;
}
} else {
...
});})(each_fixture_fn,G__31014,env,once_fixtures,each_fixtures,vec__31013,ns,vars__$1))
);
});})(each_fixture_fn,G__31014,env,once_fixtures,each_fixtures,vec__31013,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1446794903265
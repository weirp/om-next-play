...
args__17409__auto__.push((arguments[i__17403__auto___37485]));
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq37483){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37483));
});
/**
...
var vec__37488 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__37488,(0),null);
var words = cljs.core.nthnext.call(null,vec__37488,(1));
...
var G__37490 = clojure.set.rename_keys.call(null,m,kmap);
var G__37490__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__37490,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__37490);
return G__37490__$1;
} else {
return m;
}
...
var args__17409__auto__ = [];
var len__17402__auto___37493 = arguments.length;
var i__17403__auto___37494 = (0);
while(true){
if((i__17403__auto___37494 < len__17402__auto___37493)){
args__17409__auto__.push((arguments[i__17403__auto___37494]));

var G__37495 = (i__17403__auto___37494 + (1));
i__17403__auto___37494 = G__37495;
continue;
} else {
}
break;
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__37491_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__37491_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__37491_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__37491_SHARP_)){
return p1__37491_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__37491_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq37492){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37492));
});
/**
...
var vec__37499 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__37499,(0),null);
var names = cljs.core.nth.call(null,vec__37499,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__37499,tag_name,names){
return (function (p1__37496_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__37496_SHARP_));
});})(matches,vec__37499,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__37499,tag_name,names){
return (function (p1__37497_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__37497_SHARP_));
});})(matches,vec__37499,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__37500){
var vec__37503 = p__37500;
var tag = cljs.core.nth.call(null,vec__37503,(0),null);
var content = cljs.core.nthnext.call(null,vec__37503,(1));
...
var vec__37504 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__37504,(0),null);
var id = cljs.core.nth.call(null,vec__37504,(1),null);
var class$ = cljs.core.nth.call(null,vec__37504,(2),null);
...
//# sourceMappingURL=util.js.map?rel=1446795342225